...
namespace Nethermind.Crypto.SecP256r1.Benchmarks;

[SimpleJob]
public class Secp256r1Benchmarks
{
    ...
    public void VerifySignature(string type, byte[] input) => Secp256r1.VerifySignature(input);
}
